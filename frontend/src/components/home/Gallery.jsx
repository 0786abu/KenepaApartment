  ...
  return (
    <div className="py-16 max-w-6xl m-auto px-4">
        {propertyloading ? (
            ...
            <div className="grid grid-cols-1 min-[480px]:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
            {properties?.slice(0,6)?.map((property)=>{
                return(
                    <div key={property._id} className="p-2 md:p-4 rounded-md overflow-hidden bg-[#AD795B]">
                        <div>
                        ...
                        <div className="mt-4 mx-4 md:mt-6  md:mx-6 mb-2 text-center">
                            <h2 className="text-lg lg:text-xl font-bold leading-tight tracking-tight text-white">{property.title}</h2>
                            <Link to={`/detail/${property._id}`}>
